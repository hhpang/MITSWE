...
//	print_r(db_getArray($sql));
	...
	if(db_numrows($res)>0)
	{
		while($row = mysql_fetch_array($res))
		{
			...
			echo "<tr>";
			echo "<table><tr>";
			echo "<td colspan='2'><font size='3' color='black'>".$row1['firstname']." ".$row1['lastname']."</font></td>";
			echo "<tr><td valign='top' width='100'><font color='black'><b>Email (@mit.edu):</b></font></td><td>".$row1['username']."</td></tr>";
			...
			{
				echo "<tr><td>Resume:</td><td><A HREF='$server_root$location' target='_blank'>Download</a> </td></tr>";
			}
			echo "</table><hr>";
			echo "</tr>";
		}
