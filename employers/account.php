...
if($res && db_numrows($res) == 1)
{
	...
	echo "</table>";
	echo "<input type='hidden' name='e_companies_id' value=\"";form_fill_value($e_companies_id);echo "\"></td></tr>";
	echo "<input type='hidden' name='e_users_id' value=\"";form_fill_value($e_users_id);echo "\"></td></tr>";
