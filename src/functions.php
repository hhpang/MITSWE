...
$server_root="http://swe.mit.edu/resumedb"; 
...
class User{
	...
	function _sendConfirmationEmail($hash)
	{
		...
		if($this->username != "")
		{
			...
			$message .= "$server_root/students/confirm.php?user=$this->username&confirm=$hash";
...
<title>MIT Society of Women Engineers</title>
<meta name="keywords" content="" />
<meta name="description" content="" />
<link rel="stylesheet" type="text/css" href="<?php echo $prepath;?>/src/swe1.css" />
</head>
<body>
...
<div id="outer">
	...
	<div id="inner">
		...
		<div id="menu">
			<ul>
				<li class="first"><a href="http://web.mit.edu/swe/www/index.html">Home</a></li>
				<li><a href="http://web.mit.edu/swe/www/about.html">About</a></li>
				<li><a href="#">Members</a></li>
				<li><a href="#">Careers</a></li>
				<li><a href="http://web.mit.edu/swe/www/contact.html">Contact</a></li>
				<li><a href="http://swe.mit.edu">Resume Database</a></li>
			</ul>
	...
	if($_SESSION['logged'])
	{
		echo "<A HREF='$server_root/index.php?logout=true'>Logout</a>";
	}
	...
	<table><tr>
		<td><b>Resume:</b></td><td><input type="hidden" name="MAX_FILE_SIZE" value="2000000" />
			...
			<?php
				...
				{
					echo "<A HREF='$server_root$location'>Click here</a> to view your resume<br>";
