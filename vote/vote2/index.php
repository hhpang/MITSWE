...
<?php
 if (@$_SERVER['SSL_CLIENT_S_DN_CN']) {
  ...
  //Time stamp of (mm/dd/yyyy) 11/17/2014 : 0 Hours: 0 Minutes, 0 Seconds= 1416182400
 ...
 if (time()> 1416182400 && time()< 1416805200) {
	...
	$active = false;
	echo "<h2>Please note that voting is currently not active. <br><br>Vote between 12/03/11 1:00pm and 12/09/11 
 11:59pm.</h2>";
}
